...
const CardExpenseSummary = () => {
    ...
    //Using OBJECT entries to map the expense sums object so we can manipulate the data to be acceptable to display with recharts
        ...
        <>
         <div>
          ...
          <div className="xl:flex justify-between pr-7">
            ...
            <PieChart>
                <Pie data={expenseCategories} innerRadius={50} outerRadius={60} fill="#8884d8" dataKey="value" cx="50%" cy="50%">
