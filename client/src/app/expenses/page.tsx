           ...
           Filter By Category and Date
            ...
            <div className="space-y-4">
                ...
                <div>
                    ...
                    defaultValue="All" onChange={(e) => setSelectedCategory(e.target.value)}
                    >
                        <option>All</option>
                   ...
                   <div>
                    ...
                    <input name="start-date" type="date" id="start-date" className={classNames.selectInput}
                    defaultValue="All" onChange={(e) => setStartDate(e.target.value)}
                    />
                </div>
                 {/*END DATE*/}
                 <div>
                    ...
                    <input name="end-date" type="date" id="end-date" className={classNames.selectInput}
                    defaultValue="All" onChange={(e) => setEndDate(e.target.value)}
                    />
                </div>
            </div>
            </div>
